...
class ShoppingList extends Component {
  constructor(props) {
    ...
    this.state = {
      newItemName: "",
      groceryItems: [
        { name: "Augustiner", id: "item-1", completed: false },
        { name: "Hofbräu", id: "item-2", completed: true },
        { name: "Hacker-Pschorr", id: "item-3", completed: false },
        { name: "Löwenbräu", id: "item-4", completed: false },
        { name: "Paulaner", id: "item-5", completed: false },
        { name: "Spaten", id: "item-6", completed: false }
      ],
      validationErrors: {},
      submitted: 0
    };
  ...
  validateFields() {
    ...
    if (!newItemName) {
      errors["newItemName"] = "Please enter new item beer";
    }
